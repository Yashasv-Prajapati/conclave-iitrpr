...
<body>
    ...
    <section id="about" class="about-us-image py-5">
        <div class="container-fluid">
    ...
    <section id="prelude" class="background-prelude py-5">
        <div class="container-fluid">
        ...
        <div class="container-fluid">
            ...
            <div class="row justify-content-evenly my-5">
                ...
                <div class="col-md-5 w3-animate-right"
                    ...
                    <div class="my-3 agendaBlock1 square-45-1"
                        ...
                        <p class="text1">What measures can be taken to encourage more and more students to be involved in cultural activities?
                        </p>
                    </div>
                    <div class="my-3 agendaBlock1 square-45-2"
                        ...
                        <p class="text1">What components of our organizations (societies,clubs) need to be improved to adapt for smoother functioning in the current scenario?</p>
                    </div>
                    <div class="my-3 agendaBlock1 square-45-3"
                        ...
                        <p class="text1">In what ways can we restore the gap between specific batches owing to the pandemic?
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="row justify-content-evenly my-5"
                ...
                <div class="row justify-content-center">
                    ...
                    <div class="col-md-5 w3-animate-right">
                        <div id="02" class="my-3 agendaBlock square-45-2 midMentor"
                ...
                <div class="row justify-content-center">
                    <div class="col-md-5 w3-animate-left">
                        <div class="my-3 agendaBlock3"
                            ...
                            <p class="text">How can the immense potential of the curious minds be guided and motivated in the proper direction?
                    ...
                    <div class=" col-md-5 w3-animate-right">
                            <div class="my-3 agendaBlock3"
                                ...
                                <p class="text">What steps should be implemented in collaboration with government authorities to pique people's interest in this field?</p>
                            </div>
                        </div>
                    </div>
                    <div class="row justify-content-center">
                        <div class="col-md-5 w3-animate-bottom">
                            <div class="my-3 agendaBlock3"
                                ...
                                <p class="text">What all can be negotiated with the core companies in order to attract them to hire more people with good packages?
                                </p>
                            </div>
                        </div>
                    </div>
